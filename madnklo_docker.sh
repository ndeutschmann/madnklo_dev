...
if [ "$1" = "--docker_build" ]
then
	docker build --tag=madnklo/madnklo_dev:lightweight ./docker_src
	echo ""
	echo "================================================================"
...
if [ "$1" = "--docker_update" ]
then
	docker pull madnklo/madnklo_dev:lightweight
	exit
fi
...
then
	...
	madnklo/madnklo_dev:lightweight
...
madnklo/madnklo_dev:lightweight $1
